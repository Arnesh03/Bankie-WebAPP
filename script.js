...
const x = new Array(7);
//The fill methods mutates the underlying arrays
// console.log(x.fill(69));
// x.fill(88, 3);
// console.log(x);
...
// });
/////////////////////////////////////////////////////////////////////
//Lecture 166 Practicing Array methods
//Exercise 1
// const bankDepositSum = accounts
//   .flatMap(acc => acc.movements)
//   .filter(mov => mov > 0)
...
// //Exercise 3
// const { deposites, withdrawl } = accounts
//   .flatMap(acc => acc.movements)
//   .reduce(
//     (acc, cur) => {
//       // cur > 0 ? (acc.deposits += cur) : (acc.withdrawl += cur);
//       acc[cur > 0 ? 'deposites' : 'withdrawl'] += cur;
//       return acc;
//     },
//     {
//       deposites: 0,
